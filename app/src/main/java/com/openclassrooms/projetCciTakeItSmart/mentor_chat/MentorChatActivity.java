...
import com.openclassrooms.projetCciTakeItSmart.api.MessageHelper;
...
public class MentorChatActivity extends BaseActivity implements MentorChatAdapter.Listener {
    ...
    // STATIC DONNEE POUR CHAT
    private static final String CHAT_NAME_ANDROID = "android";
    private static final String CHAT_NAME_BUG = "bug";
    private static final String CHAT_NAME_FIREBASE = "firebase";

    // STATIC DONNEES POUR PICTURE
    ...
    private void uploadPhotoInFirebaseAndSendMessage(final String message) {
        String uuid = UUID.randomUUID().toString(); // GENERATATION D'UN STRING UNIQUE
        // A - UPLOAD TO GCS
        ...
        mImageRef.putFile(this.uriImageSelected)
                .addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        // B - SAUVGARDE DU MESSAGE EN FIRESTORE
    ...
    private void handleResponse(int requestCode, int resultCode, Intent data){
        if (requestCode == RC_CHOOSE_PHOTO) {
            if (resultCode == RESULT_OK) { //SUCCESS
                ...
                Glide.with(this) //AFFICHER UN PREVIEW DE L'IMAGE
    ...
    private void configureRecyclerView(String chatName){
        ...
        mentorChatAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            ...
            public void onItemRangeInserted(int positionStart, int itemCount) {
                recyclerView.smoothScrollToPosition(mentorChatAdapter.getItemCount()); // DEFILER VERS LE BAS D4UN NOUVEAU MESSAGE
            }
        });
